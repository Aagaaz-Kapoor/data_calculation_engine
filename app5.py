...
if not st.session_state.template_defined:
    ...
    if uploaded_file is not None:
        try:
            ...
            col_types_df = pd.DataFrame(auto_schema)
            st.dataframe(col_types_df, use_container_width=True, hide_index=True)
            ...
            with col_apply1:
                if st.button("✅ Apply Template & Load Data", type="primary", use_container_width=True):
                    ...
                    st.session_state.template_schema = auto_schema
